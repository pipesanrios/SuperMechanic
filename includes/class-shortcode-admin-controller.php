...
class Shortcode_Admin_Controller {
	...
	protected function get_shortcode_catalog() {
		return array(
			...
			array(
				'tag'                 => 'mekvort_mechanic_panel',
				'group'               => 'mechanic',
				'description'         => __( 'Alias general del panel mecánico Mekvort que reutiliza el render del portal mecánico existente.', 'super-mechanic' ),
				'parameters'          => array(),
				'example'             => '[mekvort_mechanic_panel]',
				'recommended_context' => __( 'Mecánico', 'super-mechanic' ),
				'usage_scope'         => __( 'Página privada autenticada para mecánicos, consistente con alias mekvort de panel.', 'super-mechanic' ),
				'source'              => 'includes/dashboard/class-mechanic-dashboard-shortcodes.php',
			),
			array(
			...
			array(
				'tag'                 => 'sm_client_panel',
				'group'               => 'client',
				'description'         => __( 'Renderiza el panel unificado de cliente con navegación interna y bloques de dashboard, vehículos, procesos, quotes e invoices.', 'super-mechanic' ),
				'parameters'          => array(
					__( '`show_overview` (opcional): `yes|no` para elegir portal mejorado o dashboard clásico.', 'super-mechanic' ),
					__( '`show_documents` (opcional): `yes|no` para mostrar bloque de documentos/timeline.', 'super-mechanic' ),
				),
				'example'             => '[sm_client_panel show_overview="yes" show_documents="yes"]',
				'recommended_context' => __( 'Cliente', 'super-mechanic' ),
				'usage_scope'         => __( 'Página privada principal del panel cliente unificado.', 'super-mechanic' ),
				'source'              => 'includes/dashboard/class-client-dashboard-shortcodes.php',
			),
			array(
				'tag'                 => 'mekvort_client_panel',
				'group'               => 'client',
				'description'         => __( 'Alias general del panel cliente Mekvort con redirección segura a login cuando no existe sesión.', 'super-mechanic' ),
				'parameters'          => array(
					__( '`show_overview` (opcional): `yes|no` para elegir portal mejorado o dashboard clásico.', 'super-mechanic' ),
					__( '`show_documents` (opcional): `yes|no` para mostrar bloque de documentos/timeline.', 'super-mechanic' ),
				),
				'example'             => '[mekvort_client_panel show_overview="yes" show_documents="yes"]',
				'recommended_context' => __( 'Cliente', 'super-mechanic' ),
				'usage_scope'         => __( 'Página privada principal en sitios que usan nomenclatura Mekvort.', 'super-mechanic' ),
				'source'              => 'includes/dashboard/class-client-dashboard-shortcodes.php',
			),
			array(
