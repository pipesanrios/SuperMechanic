<?php
/**
 * Client quotes Elementor widget.
 *
...
/**
 * Client quotes shortcode wrapper for Elementor.
 */
class Client_Quotes_Widget extends Widget_Base {
	public function get_name() {
		return 'sm-client-quotes';
	}

	public function get_title() {
		return __( 'SM Client Quotes', 'super-mechanic' );
	}
	...
	protected function render() {
		...
		echo do_shortcode( $this->build_shortcode( 'sm_client_quotes', $settings ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
