<?php
/**
 * Client invoices Elementor widget.
 *
...
/**
 * Client invoices shortcode wrapper for Elementor.
 */
class Client_Invoices_Widget extends Widget_Base {
	public function get_name() {
		return 'sm-client-invoices';
	}

	public function get_title() {
		return __( 'SM Client Invoices', 'super-mechanic' );
	}
	...
	protected function render() {
		...
		echo do_shortcode( $this->build_shortcode( 'sm_client_invoices', $settings ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
