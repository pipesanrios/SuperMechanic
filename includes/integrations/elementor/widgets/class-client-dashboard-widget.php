<?php
/**
 * Client dashboard Elementor widget.
 *
...
/**
 * Client dashboard shortcode wrapper for Elementor.
 */
class Client_Dashboard_Widget extends Widget_Base {
	public function get_name() {
		return 'sm-client-dashboard';
	}

	public function get_title() {
		return __( 'SM Client Dashboard', 'super-mechanic' );
	}
	...
	protected function render() {
		...
		echo do_shortcode( $this->build_shortcode( 'sm_client_dashboard', $settings ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
