<?php
/**
 * Client processes Elementor widget.
 *
...
/**
 * Client processes shortcode wrapper for Elementor.
 */
class Client_Processes_Widget extends Widget_Base {
	public function get_name() {
		return 'sm-client-processes';
	}

	public function get_title() {
		return __( 'SM Client Processes', 'super-mechanic' );
	}
	...
	protected function render() {
		...
		echo do_shortcode( $this->build_shortcode( 'sm_client_processes', $settings ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
