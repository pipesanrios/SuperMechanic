<?php
/**
 * Mechanic dashboard Elementor widget.
 *
...
/**
 * Mechanic dashboard shortcode wrapper for Elementor.
 */
class Mechanic_Dashboard_Widget extends Widget_Base {
	public function get_name() {
		return 'sm-mechanic-dashboard';
	}

	public function get_title() {
		return __( 'SM Mechanic Dashboard', 'super-mechanic' );
	}
	...
	protected function render() {
		...
		echo do_shortcode( $this->build_shortcode( 'sm_mechanic_dashboard', $settings ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
