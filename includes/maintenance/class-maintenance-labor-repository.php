...
/**
 * Handles maintenance labor persistence.
 */
class Maintenance_Labor_Repository {
	/**
	 * Get labor table name.
	 *
	 * @return string
	 */
	public function get_table_name() {
		...
		return $tables['maintenance_labor'];
	}

	/**
	 * Get labor rows by maintenance ID.
	 *
	 ...
	 * Insert labor row.
	 *
	 * @param array<string, mixed> $data Labor data.
	 * @return int|false
	 */
